...
export function createDemoData(): FlowLogData {
  ...
  return {
    ...
    events: [
      ...
      { id: createId("evt"), type: "urge", timestamp: at(0, 9, 0), urgency: 2, notes: "Primo stimolo" },
      { id: createId("evt"), type: "urine", timestamp: at(0, 9, 10), urgency: 2, streamStrength: 4, urineColor: "chiaro" },
      { id: createId("evt"), type: "water", timestamp: at(0, 11, 40), amountMl: 330 },
      { id: createId("evt"), type: "water", timestamp: at(1, 10, 0), amountMl: 500 },
      { id: createId("evt"), type: "urine", timestamp: at(1, 12, 20), urgency: 3, streamStrength: 3, urineColor: "giallo" },
